...
import {CallParams, XCallArgs} from "@connext/nxtp-contracts/core/connext/libraries/LibConnextStorage.sol";
...
contract Transfer {
  ...
  function transfer(
    ...
    CallParams memory callParams = CallParams({
      to: to,
      callData: bytes4(keccak256("wrap(tokens, amount)")), // empty here because we're only sending funds
